...
if __name__ == '__main__':
  #Path to the times.txt in KITTI dataset
	ground_time = np.loadtxt('/home/tuan/Downloads/Dataset/data_odometry_gray/dataset/sequences/09/times.txt')
  ...
  #Path to the ground truth file
	ground_data = np.loadtxt('/home/tuan/Downloads/Dataset/data_odometry_poses/dataset/poses/09.txt')
