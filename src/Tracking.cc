...
void Tracking::Track()
{
    ...
    {
        std::cout << "mState==NO_IMAGES_YET" << std::endl;
    ...
    else
    {
        ...
        if(!mbOnlyTracking)
        {
            ...
            std::cout << "mbOnlyTracking is false" << std::endl;
            if(mState==OK)
            {
                ...
                {
                    std::cout << "mVelocity.empty() || mCurrentFrame.mnId<mnLastRelocFrameId+2" << std::endl;
                    bOK = TrackReferenceKeyFrame();
                }
                else
                {
                    std::cout << "mVelocity not empty()" << std::endl;
        ...
        else
        {
            ...
            std::cout << "mbOnlyTracking is true" << std::endl;
            if(mState==LOST)
            {
                std::cout << "mState==LOST -> Relocalization()" << std::endl;
                bOK = Relocalization();
            }
            else
            {
                ...
                if(!mbVO)
                {
                    std::cout << "mbVO is false" << std::endl;
                ...
                {
                    std::cout << "mbVO is true" << std::endl;
                    ...
                    if(!mVelocity.empty())
                    {
                        std::cout << "mVelocity.empty() is false" << std::endl;
                    ...
                    if(bOKMM && !bOKReloc)
                    {
                        std::cout << "bOKMM && !bOKReloc is true" << std::endl;
                    ...
                    {
                        std::cout << "bOKMM && !bOKReloc is false" << std::endl;
                        mbVO = false;
                    }
        ...
        if(bOK)
        {
            std::cout << "bOK -> mState = OK;" << std::endl;
            mState = OK;
        }
...
void Tracking::StereoInitialization()
{
    ...
    {
        std::cout << "mCurrentFrame.N>500" << std::endl;
