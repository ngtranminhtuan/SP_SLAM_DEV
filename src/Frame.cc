     ...
     mpReferenceKF(static_cast<KeyFrame*>(NULL))
{
    ...
    // std::cout << "ASSIGN_KP_TO_GRID: " << end - start << std::endl;
}
     ...
     mTimeStamp(timeStamp), mK(K.clone()),mDistCoef(distCoef.clone()), mbf(bf), mThDepth(thDepth)
{
    ...
    // ORB extraction
    ExtractORB(0,imGray);
    std::cout << "RGB-D Frame Extract" << std::endl;
...
void Frame::ExtractORB(int flag, const cv::Mat &im)
{
    if(flag==0) {
        ...
        // cout << "desc size: " << mDescriptors.rows << ' ' << mDescriptors.rows << endl;
        // std::chrono::steady_clock::time_point end = std::chrono::steady_clock::now();
        // std::cout << "ORB Extract_Left: " << end - start << std::endl;
    }
    else
    {
        // std::chrono::steady_clock::time_point start = std::chrono::steady_clock::now();
        ...
        // std::chrono::steady_clock::time_point end = std::chrono::steady_clock::now();
        // std::cout << "ORB Extract_Right: " << end - start << std::endl;
    }
...
{
    std::cout << "ComputeStereoFromRGBD()" << std::endl;
    mvuRight = vector<float>(N,-1);
    mvDepth = vector<float>(N,-1);
