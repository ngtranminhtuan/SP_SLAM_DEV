...
public:
    struct frame {
        frame(const std::string& left_img_path, const std::string& right_img_path, const std::string& left_imgDepth_path, const double timestamp)
            : left_img_path_(left_img_path), right_img_path_(right_img_path), left_depth_path_(left_imgDepth_path),timestamp_(timestamp){};

        const std::string left_img_path_;
        const std::string right_img_path_;
        const std::string left_depth_path_;
...
private:
    ...
    std::vector<std::string> left_imgDepth_paths_;
};
