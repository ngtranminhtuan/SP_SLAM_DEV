...
* For more information see <https://github.com/raulmur/SP_SLAM>
*
...
{
public:
    ImageGrabber(SP_SLAM::System* pSLAM):mpSLAM(pSLAM){}

    void GrabImage(const sensor_msgs::ImageConstPtr& msg);

    SP_SLAM::System* mpSLAM;
};
...
int main(int argc, char **argv)
{
    ...
    if(argc != 3)
    {
        cerr << endl << "Usage: rosrun SP_SLAM Mono path_to_vocabulary path_to_settings" << endl;        
        ros::shutdown();
        return 1;
    }

    // Create SLAM system. It initializes all system threads and gets ready to process frames.
    SP_SLAM::System SLAM(argv[1],argv[2],SP_SLAM::System::MONOCULAR,false);
    ...
    thread tViewer = thread(&SP_SLAM::ViewerAR::Run,&viewerAR);
...
void ImageGrabber::GrabImage(const sensor_msgs::ImageConstPtr& msg)
{
    ...
    vector<SP_SLAM::MapPoint*> vMPs = mpSLAM->GetTrackedMapPoints();
